...
export const Route = createFileRoute("/products")({
  head: () => ({ meta: [
    { title: "Fresh Fruit Cups — Taza Cup" }, { name: "description", content: "Explore Taza Cup's Mango Berry and Tropical Gold fresh fruit cups." },
